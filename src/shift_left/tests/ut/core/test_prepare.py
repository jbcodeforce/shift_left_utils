...
class TestPrepareTablesFromSqlFile(BaseUT):
    ...
    def setUp(self):
        ...
        super().setUp()
        self.test_compute_pool_id = "test-pool-123"
    ...
    def test_prepare_tables_basic_functionality(
        ...
        # Setup mocks
        mock_config = {'flink': {'compute_pool_id': self.test_compute_pool_id}}
        ...
        prepare_tables_from_sql_file("test.sql")
        ...
        expected_calls = [
            call(self.test_compute_pool_id, "prepare-table-20240420101502-0", "CREATE TABLE test_table (id INT);"),
            call(self.test_compute_pool_id, "prepare-table-20240420101502-1", "ALTER TABLE test_table ADD COLUMN name STRING;"),
            call(self.test_compute_pool_id, "prepare-table-20240420101502-2", "DROP TABLE old_table;")
        ]
    ...
    def test_prepare_tables_file_not_found(self):
        ...
        with self.assertRaises(FileNotFoundError):
            prepare_tables_from_sql_file("non_existent_file.sql")
