...
from shift_left.core.deployment_mgr import _filtering_descendant_nodes, FlinkStatementNode
...
class TestFilteringAncestors(BaseUT):
    ...
    def test_filtering_descendant_nodes_same_product_name(self):
        ...
        # Act
        result = _filtering_descendant_nodes(
            ancestors=ancestors,    
